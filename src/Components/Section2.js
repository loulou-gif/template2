...
function Section2() {
    return(
        <section className="section2 bg-red-50 flex ">
            <img alt="anime" className="anime lg:w-full bg-gray-500" src={pull1} />          
            <div className="complete lg:w-8/12 w-full bg-wh border  lg:mt-40">
                <div className="mini-box mt-20 border p-5 ">
                    <h3 className='text-3xl  lg:mt-20 mt-5 border font-bold w-full'>Naruto</h3>
                ...
                <div className=" lg:flex mg:flex  h-1/4  ">
                    <div className="inside lg:w-6/12 ml:w-6/12  lg:mt-10   p-5">                    
                        <h3 className='text-3xl mt-5 font-bold border w-full'>Naruto</h3>
                    ...
                    <div className="inside  lg:w-6/12 ml:w-6/12 border  lg:mt-10 p-5">
