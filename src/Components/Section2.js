...
function Section2() {
    return(
        <section className="section2 bg-red-50 flex  ">
            ...
            <div className="complete lg:w-8/12 w-full bg-wh border md:flex md:justify-center md:flex-col md:items-center ">
                <div className="mini-box  md:w-6/12   p-5 ">
                ...
                <div className=" lg:flex h-1/4  md:w-6/12  ">
                    <div className="inside lg:w-6/12 w-full lg:mt-10   p-5">                    
