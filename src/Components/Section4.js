            ...
            <div className="flex   p-5 w-full h-full">
                <div className="w-6/12 bg-white p-5">
                    <div className="flex justify-evenly w-full h-2/4">   
                        <img alt='' src={sangoku} className='w-5/12'/>
                        <img alt='' src={hunter} className='w-5/12'/>
                    </div>
                    <div className="flex justify-evenly w-full h-2/4  mt-5">   
                        <img alt='' src={netero} className='w-5/12'/>
                        <img alt='' src={ghoul} className='w-5/12'/>
                    </div>
                </div>
                <div className="w-6/12 -l-8 bg-white p-5">
                    <div className="flex justify-evenly w-full h-2/4">   
                        <img alt='' src={hunter2} className='w-5/12'/>
                        <img alt='' src={sangoku2} className='w-5/12'/>
                    </div>
                    <div className="flex justify-evenly w-full h-2/4  mt-5">   
                        <img alt='' src={school} className='w-5/12'/>
                        <img alt='' src={netero2} className='w-5/12'/>
                    </div>
                </div>
            </div>
        </section>
