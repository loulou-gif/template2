...
function Section8() {
    return(
        <section className="section8 flex flex-col md:flex-row lg:flex-row p-10 bg-black text-white">
            <div className="lg:w-6/12 w-3/12 md:w-6/12 h-2/4 md:h-full lg:h-full flex md:justify-center lg:justify-center md:items-center lg:items-center">
            ...
            <div className="h-full lg:w-6/12 flex lg:justify-center md:justify-center md:items-center lg:items-center  ">
                <iframe title='map' className='h-4/6 lg:w-7/12 md:w-full w-full' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.31823678591!2d-3.9558710259081797!3d5.368339835510069!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc1eb687564e241%3A0xad68bfef48b8dcf3!2zU2ltcGxvbiBDw7R0ZSBk4oCZSXZvaXJl!5e0!3m2!1sfr!2sci!4v1706205425367!5m2!1sfr!2sci" 
                    allowfullscreen="" 
                    // width="200"
                    height="400"
                    loading="lazy"
